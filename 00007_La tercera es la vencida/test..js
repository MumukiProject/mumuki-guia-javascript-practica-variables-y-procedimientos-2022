  ...
  describe("Si tenemos 100000 en el pozo y aplicamos el IVG el pozo queda en 99500", function() {
  ...
  describe("Si tenemos 100000 en el pozo y aplicamos el IVG tres veces el pozo queda en 98500", function() {
  it("Descripción del ejemplo", function() {
    pozo = 100000
    aplicarIvg()
    aplicarIvg()
